...
CFireBreathEffect::CFireBreathEffect(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrTexName, wstring wstrParentInstName, string strBoneName, _vec2 vScale, _vec3 vPos, _vec3 vDir, _bool bIsDistortion, _float fMaxScale)
	: CGameEffect(pGraphicDev, wstrTexName, wstrParentInstName, strBoneName, vScale, vPos), m_bIsDistortion(bIsDistortion), m_vDir(vDir)
{
	m_fVerticalTime = 0.f;
	m_bIsTracking=false;
...
CFireBreathEffect::~CFireBreathEffect(void)
{

}

HRESULT CFireBreathEffect::Ready_GameObject(void)
{
...
HRESULT CFireBreathEffect::LateReady_GameObject(void)
...
_int CFireBreathEffect::Update_GameObject(const _float& fTimeDelta)
{
...
void CFireBreathEffect::Render_GameObject(void)
{
...
HRESULT CFireBreathEffect::Add_Component(void)
{
...
HRESULT CFireBreathEffect::SetUp_ConstantTable(LPD3DXEFFECT& pEffect)
{
...
void CFireBreathEffect::Set_ChargeSpeed(_float fSpeed)
{
	m_fSCTimeSpeed = fSpeed;
}

void CFireBreathEffect::Charge_Scale(_float fTimeDelta, _float fMaxScale)
{
...
void CFireBreathEffect::Set_Distortion()
{
	m_bIsDistortion = true;
}

void CFireBreathEffect::VerticalMove(_float fTimeDelta)
{
...
void CFireBreathEffect::Set_Enable(bool bEnable)
{
	m_bEnable = bEnable;
	m_bIsStart = bEnable;
	if (bEnable)
...
void CFireBreathEffect::Set_Enable(bool bEnable, _vec3 vAddPos)
{
	m_bEnable = bEnable;
	m_bIsStart = bEnable;
	if (bEnable)
...
CFireBreathEffect * CFireBreathEffect::Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrTexName, wstring wstrParentInstName, string strBoneName, _vec2 vScale, _vec3 vPos, _vec3 vDir, _bool bIsDistortion, _float fMaxScale)
{
	CFireBreathEffect*	pInstance = new CFireBreathEffect(pGraphicDev, wstrTexName, wstrParentInstName, strBoneName, vScale, vPos, vDir,bIsDistortion, fMaxScale);
...
void CFireBreathEffect::Free(void)
{
