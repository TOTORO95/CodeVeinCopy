...
CGroundEffect::CGroundEffect(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrTexName,  _vec2 vScale,_vec3 vPos, _bool bIsLoop)
...
CGroundEffect::CGroundEffect(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrTexName, wstring wstrParentInstName, string strBoneName, _vec2 vScale, _vec3 vPos)
...
CGroundEffect::CGroundEffect(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrTexName, wstring wstrParentInstName, string strBoneName, _vec2 vScale,_vec3 vPos, _bool bIsTracking, _bool bIsLoop)
	: CGameEffect(pGraphicDev, wstrTexName, wstrParentInstName, strBoneName, vScale, vPos, bIsTracking, bIsLoop)
{

}

CGroundEffect::~CGroundEffect(void)
{

}

HRESULT CGroundEffect::Ready_GameObject(void)
{
...
HRESULT CGroundEffect::LateReady_GameObject(void)
...
_int CGroundEffect::Update_GameObject(const _float& fTimeDelta)
{
...
void CGroundEffect::Render_GameObject(void)
{
...
HRESULT CGroundEffect::Add_Component(void)
{
...
HRESULT CGroundEffect::SetUp_ConstantTable(LPD3DXEFFECT& pEffect)
{
...
void CGroundEffect::Splash_Scale(_float fTimeDelta, _float fMaxScale)
{
...
void CGroundEffect::Set_Distortion()
{
	m_bIsDistortion = true;
}

void CGroundEffect::VerticalMove(_float fTimeDelta)
{
...
void CGroundEffect::Set_Enable(bool bEnable)
{
	m_bEnable = bEnable;
	if (bEnable)
	{
...
void CGroundEffect::Set_Enable(bool bEnable, _vec3 vAddPos)
{
	m_bEnable = bEnable;
	if (bEnable)
	{
...
void CGroundEffect::Set_ScaleSpeed(_float fTimeSpeed)
{
	m_fSCTimeSpeed = fTimeSpeed;
}


CGroundEffect * CGroundEffect::Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrTexName, _vec2 vScale, _vec3 vPos, _bool bIsLoop)
{
	CGroundEffect*	pInstance = new CGroundEffect(pGraphicDev, wstrTexName, vScale, vPos, bIsLoop);
...
CGroundEffect * CGroundEffect::Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrTexName, wstring wstrParentInstName, string strBoneName, _vec2 vScale, _vec3 vPos)
{
	CGroundEffect*	pInstance = new CGroundEffect(pGraphicDev, wstrTexName, wstrParentInstName, strBoneName, vScale, vPos);
...
CGroundEffect * CGroundEffect::Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrTexName, wstring wstrParentInstName, string strBoneName, _vec2 vScale, _vec3 vPos, _bool bIsTracking, _bool bIsLoop)
{
	CGroundEffect*	pInstance = new CGroundEffect(pGraphicDev, wstrTexName, wstrParentInstName, strBoneName,  vScale, vPos, bIsTracking, bIsLoop);
